            ...
            <section class="content ov_info">
                ...
                <div class="box">
                    <form action="index.php" method="post" name="adminForm" id="adminForm">
                        ...
                        <div action="index.php" method="post" name="adminForm" id="adminForm">
                            <div class="box">
                                ...
                                <table cellpadding="4" cellspacing="0" border="0" width="100%"
									...
									for ($i = 0, $n = count($this->icalrows); $i < $n; $i++)
									{
                                        ...
                                        <tr class="row<?php echo $k; ?>">
                                            ...
                                            <td width="30%">
                                                <a href="#edit"
                                                   onclick="return listItemTask('cb<?php echo $i; ?>','icalrepeat.edit')"
                                    ...
                                    <tr>
                                        <th align="center"
                                            colspan="3"><?php echo $this->pageNav->getListFooter(); ?></th>
                                    </tr>
                                </table>
