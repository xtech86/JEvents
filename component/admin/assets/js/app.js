...
if (typeof jQuery === "undefined") {
  throw new Error("JEvents Admin UI requires jQuery");
}
...
jQuery(function () {
  ...
  jQuery("#jev_adminui").removeClass("hold-transition");
...
function _init() {
  ...
  jQuery.AdminLTE.layout = {
    ...
    fix: function () {
      ...
      if (jQuery("#jev_adminui").hasClass("fixed")) {
  ...
  jQuery.AdminLTE.pushMenu = {
    activate: function (toggleBtn) {
      ...
      jQuery(toggleBtn).on('click', function (e) {
        ...
        if (jQuery(window).width() > (screenSizes.sm - 1)) {
          if (jQuery("#jev_adminui").hasClass('sidebar-collapse')) {
            jQuery("#jev_adminui").removeClass('sidebar-collapse').trigger('expanded.pushMenu');
          } else {
            jQuery("#jev_adminui").addClass('sidebar-collapse').trigger('collapsed.pushMenu');
          }
        }
        //Handle sidebar push menu for small screens
        else {
          if (jQuery("#jev_adminui").hasClass('sidebar-open')) {
            jQuery("#jev_adminui").removeClass('sidebar-open').removeClass('sidebar-collapse').trigger('collapsed.pushMenu');
          } else {
            jQuery("#jev_adminui").addClass('sidebar-open').trigger('expanded.pushMenu');
          }
        }
      });
      ...
      jQuery(".content-wrapper").click(function () {
        ...
        if (jQuery(window).width() <= (screenSizes.sm - 1) && jQuery("#jev_adminui").hasClass("sidebar-open")) {
          jQuery("#jev_adminui").removeClass('sidebar-open');
        }
      });

      //Enable expand on hover for sidebar mini
      if (jQuery.AdminLTE.options.sidebarExpandOnHover
          || (jQuery('#jev_adminui').hasClass('fixed')
          && jQuery('#jev_adminui').hasClass('sidebar-mini'))) {
        this.expandOnHover();
      }
    },
    expandOnHover: function () {
      ...
      jQuery('.main-sidebar').hover(function () {
        if (jQuery('#jev_adminui').hasClass('sidebar-mini')
            && jQuery("#jev_adminui").hasClass('sidebar-collapse')
            && jQuery(window).width() > screenWidth) {
          _this.expand();
        }
      }, function () {
        if (jQuery('#jev_adminui').hasClass('sidebar-mini')
            && jQuery('#jev_adminui').hasClass('sidebar-expanded-on-hover')
            && jQuery(window).width() > screenWidth) {
          _this.collapse();
        }
      });
    ...
    expand: function () {
      jQuery("#jev_adminui").removeClass('sidebar-collapse').addClass('sidebar-expanded-on-hover');
    },
    collapse: function () {
      if (jQuery('#jev_adminui').hasClass('sidebar-expanded-on-hover')) {
        jQuery('#jev_adminui').removeClass('sidebar-expanded-on-hover').addClass('sidebar-collapse');
      }
    }
  };
  ...
  jQuery.AdminLTE.controlSidebar = {
    ...
    activate: function () {
      ...
      btn.on('click', function (e) {
        ...
        if (!sidebar.hasClass('control-sidebar-open')
            && !jQuery('#jev_adminui').hasClass('control-sidebar-open')) {
          //Open the sidebar
    ...
    open: function (sidebar, slide) {
      ...
      if (slide) {
        ...
        jQuery('#jev_adminui').addClass('control-sidebar-open');
      }
    },
    ...
    close: function (sidebar, slide) {
      if (slide) {
        ...
        jQuery('#jev_adminui').removeClass('control-sidebar-open');
      }
    },
    _fix: function (sidebar) {
      var _this = this;
      if (jQuery("#jev_adminui").hasClass('layout-boxed')) {
